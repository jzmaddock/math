...
inline bool isnormal(concepts::real_concept const& val) { return (boost::math::isnormal)(val.value()); }
inline bool isinf(concepts::real_concept const& val) { return (boost::math::isinf)(val.value()); }
inline bool isnan(concepts::real_concept const& val) { return (boost::math::isnan)(val.value()); }
