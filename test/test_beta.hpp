...
void test_spots(T)
{
   ...
   BOOST_CHECK_CLOSE(::boost::math::beta(static_cast<T>(0.0125L), static_cast<T>(1) / (1024 * 16)), static_cast<T>(16463.979525483683527350840049467919556894313854322503568177303599L), tolerance * 2);
}
