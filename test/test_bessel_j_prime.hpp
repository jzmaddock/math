   ...
   // 
    ...
    static const boost::array<boost::array<typename table_type<T>::type, 3>, 8> j0_data = {{
       {{ SC_(0.0), SC_(0.0), SC_(0.0) }},
        {{ SC_(0.0), SC_(1.0), SC_(-0.440050585744933515959682203718914913127372301992765251136758171) }},
        {{ SC_(0.0), SC_(-2.0), SC_(0.5767248077568733872024482422691370869203026897196754401211390207) }},
        {{ SC_(0.0), SC_(4.0), SC_(0.0660433280235491361431854208032750287274234195317075604472299422) }},
        {{ SC_(0.0), SC_(-8.0), SC_(0.2346363468539146243812766515904546115487521615371914502337884281) }},
        {{ SC_(0.0), SC_(1e-05), SC_(-4.999999999937500000000260416666666124131944445122612847221e-6) }},
        {{ SC_(0.0), SC_(1e-10), SC_(-4.99999999999999999999375000000000000000000260416666666666e-11) }},
        {{ SC_(0.0), SC_(-10.0), SC_(0.0434727461688614366697487680258592883062728671185942081359143226) }},
    }};
    static const boost::array<boost::array<T, 3>, 6> j0_tricky = {{
        // Big numbers make the accuracy of std::sin the limiting factor:
       {{ SC_(0.0), SC_(1e+03), SC_(-0.004728311907089523917576071901216916285418024202059636868719721) }},
        {{ SC_(0.0), SC_(1e+05), SC_(-0.001846757562882567716362123967114215743693904528858467573566724) }},
        // test at the regular Bessel roots:
        {{ SC_(0.0), T(2521642)/(1024 * 1024), SC_(-0.51914757222577856454854157661289845339279380579340006782986658) }},
        {{ SC_(0.0), T(5788221)/(1024 * 1024), SC_(0.3402648315170911433607274962948747647608376651625800510779161129) }},
        {{ SC_(0.0), T(9074091)/(1024 * 1024), SC_(-0.271452311894657014854145327490965399410147486470376880707929373) }},
        {{ SC_(0.0), T(12364320)/(1024 * 1024), SC_(0.2324598316641066033541448467171088144257741833078981111378449088) }}
    }};    
    ...
    static const boost::array<boost::array<T, 3>, 5> j1_tricky = {{
        // Big numbers make the accuracy of std::sin the limiting factor:
        {{ SC_(1.0), SC_(1000.), SC_(0.0247819578405130850374131550437924918698810291090444887779382302) }},
        {{ SC_(1.0), SC_(100000.), SC_(-0.001719219583811601018247765098312872889689693339732394943937929) }},
        // test at the regular Bessel roots:
    ...
    static const boost::array<boost::array<typename table_type<T>::type, 3>, 17> jn_data = {{
        ...
        {{ SC_(10.0), SC_(-10.0), SC_(-0.084369578631761188248490512733376983041650793639156473262693897) }},
        ...
        {{ SC_(10.0), SC_(1e+06), SC_(-0.000725951803719324335038787573389363596244265216142949209996916) }},
        {{ SC_(1e+02), SC_(8e+01), SC_(3.5036060582489177538508950593467499997755458120649269214352e-6) }},
        {{ SC_(1e+03), SC_(1e+05), SC_(-0.002172446977760839340985075822746577648557209118811950682915414) }},
