...
void test_spots(T)
{
   ...
   {
      T big_tol = std::numeric_limits<T>::digits > 100 ? tolerance * 5 : tolerance;
      BOOST_CHECK_CLOSE(::boost::math::tgamma(static_cast<T>(170), static_cast<T>(165)), static_cast<T>(2.737338337642022829223832094019477918166996032112404370e304L), big_tol);
      BOOST_CHECK_CLOSE(::boost::math::tgamma_lower(static_cast<T>(170), static_cast<T>(165)), static_cast<T>(1.531729671362682445715419794880088619901822603944331733e304L), big_tol);
